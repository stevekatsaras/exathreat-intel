...
To download the latest, please visit: https://www.maxmind.com/en/accounts/<MAXMIND_ACCOUNT_ID>/geoip/downloads
...
*. docker tag exathreat-intel <AWS_ACCOUNT_ID>.dkr.ecr.ap-southeast-2.amazonaws.com/exathreat-intel

To push your tagged docker image to your ECR repository in AWS:
*. docker push <AWS_ACCOUNT_ID>.dkr.ecr.ap-southeast-2.amazonaws.com/exathreat-intel

To pull your docker image from your ECR repository in AWS:
*. docker pull <AWS_ACCOUNT_ID>.dkr.ecr.ap-southeast-2.amazonaws.com/exathreat-intel
